...
本仓库当前以 GitHub `main` 分支内容为准。仓库没有发布 Git tag 或 GitHub Release，因此本文件不把历史版本号当成可追溯发布记录使用。

## 当前包含的内容

- `SKILL.md`：skill 的机器名、触发场景、硬性规则、标准项目文件、章节流程和按需读取参考文档的规则。
...
- `references/chapter-control-card.md`
