...
Before each chapter, read at minimum:
...
If recurrence density is high:

- prepare a short retrieval slice instead of rereading blindly
- identify the characters, relationships, plotlines, foreshadows, debts, and world rules actually in play
- mark what is hot, what is running cold, and what must not disappear here

## 2. Post-Chapter Writeback Is Mandatory

After each accepted chapter:

- update dynamic state
- update any changed cast, relationship, world, plotline, or foreshadow files
- update last meaningful touch and return-pressure notes where needed
...
Run [state-health-check.md](state-health-check.md) every `10-20` chapters, after major rewrites, before volume finales, and whenever canon files disagree.
