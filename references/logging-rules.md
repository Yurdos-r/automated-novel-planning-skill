...
- whether pre-landing gates ran
- whether chapter lint ran
- pre-landing blockers fixed
- formal chapter review rating
- whether canon writeback was allowed
- rewrite pass number
...
- pre_landing_gates_ran: yes
- chapter_lint_ran: yes
- pre_landing_blockers_fixed:
  - unpaired quote in draft
- formal_chapter_review_rating: B
- canon_writeback_allowed: yes
- rewrite_pass: 1
