...
After every accepted chapter that has passed pre-landing gates and formal review, update `08-dynamic-state.md` with:
...
If review or lint finds blocking file hygiene, state drift, duplicate control cards, or a failed chapter review, repair and rerun the affected gate before canon writeback.
...
- saving a draft into `chapters/` before pre-landing gates pass
- updating dynamic state before formal chapter review allows canon writeback
