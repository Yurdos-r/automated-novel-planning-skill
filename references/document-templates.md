...
- `drafts/`
  - store working manuscripts before pre-landing gates pass
  - do not treat drafts as canon
- `chapters/`
...
- `review/reports/`
  - store formal chapter review reports when the project uses review gates
  - default naming: `NN-<chapter-title>-review.md`
...
## Optional: `10-mechanics-calibration.md`

Use [mechanics-calibration-template.md](mechanics-calibration-template.md) when generic genre convention may conflict with project-specific rules.
